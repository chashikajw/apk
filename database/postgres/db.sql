GRANT ALL PRIVILEGES ON DATABASE "WSO2AM_DB" TO wso2carbon;
    \c "WSO2AM_DB"
        ...
        FOREIGN KEY(USER_UUID) REFERENCES USER(UUID) ON UPDATE CASCADE ON DELETE RESTRICT,
        PRIMARY KEY(UUID),
        ...
        PRIMARY KEY(APPLICATION_UUID,KEY_TYPE,KEY_MANAGER)
        );
        ...
        USER_UUID INTEGER,
        FOREIGN KEY(API_UUID) REFERENCES API(UUID) ON UPDATE CASCADE ON DELETE CASCADE,
        FOREIGN KEY(USER_UUID) REFERENCES USER(UUID) ON
        ...
        APPLICATION_UUID INTEGER NOT NULL,
